...
export const VALOR_ADICIONAL_FAIXA_2 = 1711.01; // Valor adicional para a segunda faixa (1st faixa * 0.8)
export const VALOR_SALARIO_FAMILIA = 64.13; // Valor do salário-família 2025
export const LIMITE_SALARIO_FAMILIA = 1819.26; // Limite para salário-família 2025